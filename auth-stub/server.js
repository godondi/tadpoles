...
const USERS = {
  alice: { password: 'tadpole1', roles: ['ADMIN'] },
  bob: { password: 'tadpole1', roles: ['AUDITOR'] },
  charlie: { password: 'tadpole1', roles: ['ANALYST'] },
  dylan: { password: 'tadpole1', roles: ['ADVISOR'] },
  evan: { password: 'tadpole1', roles: ['CLIENT'] },
};
